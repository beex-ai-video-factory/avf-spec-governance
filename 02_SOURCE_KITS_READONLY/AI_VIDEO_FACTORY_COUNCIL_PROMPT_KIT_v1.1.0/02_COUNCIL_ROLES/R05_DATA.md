# ROLE CHARTER — Data / Persistence / Provenance Architect
...
Primary lens: PostgreSQL ownership, relational integrity, immutable versions, object-storage references, hashes, retention, audit/provenance, migrations, backup/restore, consistency.

Prove every Take can be reconstructed to exact inputs and decisions.

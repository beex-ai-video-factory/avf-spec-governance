# ROLE CHARTER — Platform / Observability / Operations Architect
...
Primary lens: traces, logs, metrics, correlation IDs, SLOs, worker health, dashboards, alerting, backups, deployment, config/secrets, release manifests, operational debugging.

Every production incident should be diagnosable from persisted evidence.

# REPOSITORY CONTEXT PROFILE — avf-google-flow-adapter

## Mission
Map provider-level Flow requests/status into the frozen FlowExecutionPort.

## Non-goal
Must not leak FlowKit/private browser protocol upstream.

# REPOSITORY CONTEXT PROFILE — avf-integration-harness

## Mission
Own independent contract/integration/fault-injection/system compatibility verification.

## Non-goal
Must not modify components merely to make integration tests pass.

# REPOSITORY CONTEXT PROFILE — avf-qc

## Mission
Own technical QC plus semantic-evaluator contract/result production.

## Non-goal
Must not autonomously trigger unlimited generation retries.

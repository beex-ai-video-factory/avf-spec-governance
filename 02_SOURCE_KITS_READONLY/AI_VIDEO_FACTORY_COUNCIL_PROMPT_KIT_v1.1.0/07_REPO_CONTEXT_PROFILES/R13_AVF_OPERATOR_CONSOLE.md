# REPOSITORY CONTEXT PROFILE — avf-operator-console

## Mission
Own operator views/actions over stable Core/Workflow APIs.

## Non-goal
Must not mutate database directly or embed provider/browser logic.

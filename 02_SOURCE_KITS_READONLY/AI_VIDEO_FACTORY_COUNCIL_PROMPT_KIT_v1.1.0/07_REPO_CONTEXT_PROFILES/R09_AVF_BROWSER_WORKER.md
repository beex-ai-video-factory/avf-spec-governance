# REPOSITORY CONTEXT PROFILE — avf-browser-worker

## Mission
Track A: own local Chrome/MV3 deterministic execution, session lifecycle, diagnostics and command execution.

## Non-goal
Must not own generation business truth or retry budgets.

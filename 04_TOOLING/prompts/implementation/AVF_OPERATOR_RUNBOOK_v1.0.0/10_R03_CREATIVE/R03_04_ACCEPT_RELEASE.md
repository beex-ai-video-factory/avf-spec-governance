# R03 CREATIVE & SCRIPT GENERATION ENGINE — ACCEPTANCE & RELEASE
## AI Video Factory — Formal Acceptance, Merge & Version Tagging

**PROMPT_ID:** `R03-04`  
**PURPOSE:** Conduct formal acceptance signoff for R03_creative (Creative & Script Generation Engine), merge feature branch to main, apply annotated git release tag, and unlock downstream dependency gates.  
...
**COMMAND_TO_RUN:**
```bash
/goal Read 04_TOOLING/prompts/implementation/AVF_OPERATOR_RUNBOOK_v1.0.0/10_R03_CREATIVE/R03_04_ACCEPT_RELEASE.md and execute it completely.
```  
**EXPECTED_ARTIFACTS:**
...
- Clean merge commit and git tag `r03_creative-v1.0.0` applied.
...
**NEXT_PROMPT_IF_PASS:** `04_TOOLING/prompts/implementation/AVF_OPERATOR_RUNBOOK_v1.0.0/11_R04_ASSETS_CONTINUITY/R04_01_PLAN.md`  
...
1. **Verify Audit Signoff:**
   Inspect `05_IMPLEMENTATION/repos/R03_creative/AUDIT_REPORT.md` and confirm PASS verdict.
2. **Merge to Main Branch:**
   Checkout `main` and merge `feature/r03-impl` cleanly:
   `git checkout main && git merge --no-ff feature/r03-impl -m "feat(r03): complete R03_creative implementation"`
3. **Apply Release Tag:**
   Apply annotated git tag:
   `git tag -a "r03_creative-v1.0.0" -m "Release R03_creative v1.0.0"`
4. **Update System Runtime State:**
   In `05_IMPLEMENTATION/operator-state/RUN_STATE.yaml`, set `R03_creative.status: "RELEASED"` and record commit SHA and tag.
...
BLOCKERS: []
ARTIFACTS_CREATED:
  - "05_IMPLEMENTATION/repos/R03_creative/ (tagged r03_creative-v1.0.0)"
  - "05_IMPLEMENTATION/operator-state/RUN_STATE.yaml"
RECOMMENDED_NEXT_PROMPT: "04_TOOLING/prompts/implementation/AVF_OPERATOR_RUNBOOK_v1.0.0/11_R04_ASSETS_CONTINUITY/R04_01_PLAN.md"

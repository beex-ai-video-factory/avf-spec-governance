# REPOSITORY BLUEPRINT: R03 — CREATIVE
**REPOSITORY_CODE:** R03
...
## 1. Responsibility
Scene decomposition, script parsing, shot planning, and creative direction compilation.

## 2. Does NOT Own
Direct video rendering, canonical database writes, provider SDK calls.

# REPOSITORY BLUEPRINT: R13 — OPERATOR CONSOLE
**REPOSITORY_CODE:** R13
**ARCHITECTURAL_LAYER:** Layer 5
**VERSION:** 1.0.0

---

## 1. Responsibility
Web UI and operator REST APIs for pipeline monitoring, human-in-the-loop approvals, and retry triggers.

## 2. Does NOT Own
Direct canonical database modification, raw worker DOM automation.

# REPOSITORY BLUEPRINT: R10 — FLOWKIT BRIDGE
**REPOSITORY_CODE:** R10
...
## 1. Responsibility
Track B Headless FlowKit execution bridge implementing FlowExecutionPort.

## 2. Does NOT Own
Browser DOM extension hooks, canonical state ownership, video editing.

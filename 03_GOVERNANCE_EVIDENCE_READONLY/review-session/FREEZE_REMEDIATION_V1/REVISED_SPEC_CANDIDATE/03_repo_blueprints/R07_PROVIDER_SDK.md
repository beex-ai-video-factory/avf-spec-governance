# REPOSITORY BLUEPRINT: R07 — PROVIDER SDK
**REPOSITORY_CODE:** R07
...
## 1. Responsibility
Provider abstraction interfaces, rate limiting, request validation, and normalized error mapping.

## 2. Does NOT Own
Direct database access, browser extension injection, video file editing.

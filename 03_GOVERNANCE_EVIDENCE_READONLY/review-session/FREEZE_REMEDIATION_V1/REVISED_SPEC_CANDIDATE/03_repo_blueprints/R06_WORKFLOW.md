# REPOSITORY BLUEPRINT: R06 — WORKFLOW ENGINE
**REPOSITORY_CODE:** R06
...
## 1. Responsibility
Temporal durable workflow orchestration for video generation pipelines, retries, and compensation.

## 2. Does NOT Own
Direct database manipulation, DOM automation, prompt compilation.

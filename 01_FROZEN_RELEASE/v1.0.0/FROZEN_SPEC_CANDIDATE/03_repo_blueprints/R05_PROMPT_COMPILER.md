# REPOSITORY BLUEPRINT: R05 — PROMPT COMPILER
**REPOSITORY_CODE:** R05
...
## 1. Responsibility
3-layer prompt compilation (Semantic AST -> Engine IR -> Target Payload) and provider syntax mapping.

## 2. Does NOT Own
Executing video generation, managing credit balances, video transcoding.
